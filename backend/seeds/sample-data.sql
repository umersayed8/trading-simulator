-- Sample Data for StockSim
-- Run this after the migrations to populate initial data
...
-- Note: Users and their portfolios are created through the registration process
-- The sample data above provides the gamification and learning content
